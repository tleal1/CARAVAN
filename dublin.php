...
<body>
    ...
    <section class="container">
        <div class="text-center my-5">
            ...
            <h2 class="display-4 text-primary">Dublin</h2>
        </div>

        <div class="row">
            <div class="col-md">
                <img class="img-fluid mb-4" src="img/local/dublin/foto-1.jpg" alt="Foto 1">
                <img class="img-fluid mb-4" src="img/local/dublin/foto-2.jpg" alt="Foto 2">
                <img class="img-fluid mb-4" src="img/local/dublin/foto-3.jpg" alt="Foto 3">
            </div>
            <div class="col-md">
                <img class="img-fluid mb-4" src="img/local/dublin/foto-4.jpg" alt="Foto 4">
                <img class="img-fluid mb-4" src="img/local/dublin/foto-5.jpg" alt="Foto 5">
            </div>
            <div class="col-md">
                <img class="img-fluid mb-4" src="img/local/dublin/foto-6.jpg" alt="Foto 6">
                <img class="img-fluid mb-4" src="img/local/dublin/foto-7.jpg" alt="Foto 7">
            </div>
        </div>
    </section>
    ...
    <section class="container">
        ...
        <table class="table table-hover table-responsive-md">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">04/02</th>
                <td>Comedy @ The International</td>
                <td>The International Bar</td>
                <td><button type="button" class="btn btn-outline-dark">Comprar Ticket</button></td>
              </tr>
              <tr>
                <th scope="row">04/02</th>
                <td>Musical Dublin Free Tour</td>
                <td>The Old Storehouse Bar and Restaurant</td>
                <td><button type="button" class="btn btn-outline-dark">Comprar Ticket</button></td>
              </tr>
              <tr>
              ...
              <tr>
                <th scope="row">05/02</th>
                <td>Ladies Night</td>
                <td>Vela Restaurant</td>
                <td><button type="button" class="btn btn-outline-dark">Comprar Ticket</button></td>
              </tr>
              <tr>
                <th scope="row">05/02</th>
                <td>Fridays @Tramline</td>
                <td>Tramline</td>
                <td><button type="button" class="btn btn-outline-dark">Comprar Ticket</button></td>
              </tr>
              <tr>
