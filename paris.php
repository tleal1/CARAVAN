...
<body>
    ...
    <section class="container">
        <div class="text-center my-5">
            ...
            <h2 class="display-4 text-primary">Paris</h2>
        </div>

        <div class="row">
            <div class="col-md">
                <img class="img-fluid mb-4" src="img/local/paris/foto-1.jpg" alt="Foto 1">
                <img class="img-fluid mb-4" src="img/local/paris/foto-2.jpg" alt="Foto 2">
            </div>
            <div class="col-md">
                <img class="img-fluid mb-4" src="img/local/paris/foto-3.jpg" alt="Foto 3">
                <img class="img-fluid mb-4" src="img/local/paris/foto-4.jpg" alt="Foto 4">
            </div>
            <div class="col-md">
                <img class="img-fluid mb-4" src="img/local/paris/foto-5.jpg" alt="Foto 5">
                <img class="img-fluid mb-4" src="img/local/paris/foto-6.jpg" alt="Foto 6">
        ...
        <table class="table table-hover table-responsive-md">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Muvrini</td>
                <td>Théâtre du Casino</td>
                <td><button type="button" class="btn btn-outline-dark">Comprar Ticket</button></td>
              </tr>
              <tr>
                <th scope="row">06/02</th>
                <td>Julie Zenatti em Paris</td>
                <td>Le Trianon</td>
                <td><button type="button" class="btn btn-outline-dark">Comprar Ticket</button></td>
              </tr>
              <tr>
                <th scope="row">09/02</th>
                <td>Cheap Trick - Paris</td>
                <td>Alhambra</td>
                <td><button type="button" class="btn btn-outline-dark">Comprar Ticket</button></td>
              </tr>
              <tr>
